...
};var changeToken = function changeToken() {
  // if (ticTacToe.turn === 'o') {
  // ticTacToe.turn = 'x'
  // ticTacToe.turn = 'o'
...
var updateGame = function updateGame(index, turn) {
...
var checkForWinner = function checkForWinner() {
  ...
  if (ticTacToe.cells[0] === 'x' && ticTacToe.cells[1] === 'x' && ticTacToe.cells[2] === 'x' || ticTacToe.cells[3] === 'x' && ticTacToe.cells[4] === 'x' && ticTacToe.cells[5] === 'x' || ticTacToe.cells[6] === 'x' && ticTacToe.cells[7] === 'x' && ticTacToe.cells[8] === 'x' || ticTacToe.cells[0] === 'x' && ticTacToe.cells[3] === 'x' && ticTacToe.cells[6] === 'x' || ticTacToe.cells[1] === 'x' && ticTacToe.cells[4] === 'x' && ticTacToe.cells[7] === 'x' || ticTacToe.cells[2] === 'x' && ticTacToe.cells[5] === 'x' && ticTacToe.cells[8] === 'x' || ticTacToe.cells[0] === 'x' && ticTacToe.cells[4] === 'x' && ticTacToe.cells[8] === 'x' || ticTacToe.cells[2] === 'x' && ticTacToe.cells[4] === 'x' && ticTacToe.cells[6] === 'x') {
  ...
  } else if (ticTacToe.cells[0] === 'o' && ticTacToe.cells[1] === 'o' && ticTacToe.cells[2] === 'o' || ticTacToe.cells[3] === 'o' && ticTacToe.cells[4] === 'o' && ticTacToe.cells[5] === 'o' || ticTacToe.cells[6] === 'o' && ticTacToe.cells[7] === 'o' && ticTacToe.cells[8] === 'o' || ticTacToe.cells[0] === 'o' && ticTacToe.cells[3] === 'o' && ticTacToe.cells[6] === 'o' || ticTacToe.cells[1] === 'o' && ticTacToe.cells[4] === 'o' && ticTacToe.cells[7] === 'o' || ticTacToe.cells[2] === 'o' && ticTacToe.cells[5] === 'o' && ticTacToe.cells[8] === 'o' || ticTacToe.cells[0] === 'o' && ticTacToe.cells[4] === 'o' && ticTacToe.cells[8] === 'o' || ticTacToe.cells[2] === 'o' && ticTacToe.cells[4] === 'o' && ticTacToe.cells[6] === 'o') {
...
var onShowGame = function onShowGame(event) {
  var data = getFormFields(this);
  event.preventDefault();
  gameApi.showGame(data).then(gameUi.showGameSuccess).catch(gameUi.showGameFailure);
...
var onShowAllGames = function onShowAllGames(event) {
  var data = getFormFields(this);
  event.preventDefault();
  gameApi.showAllGames(data).then(gameUi.showAllGamesSuccess).catch(gameUi.showAllGamesFailure);
};
...
var onShowGameOverTrue = function onShowGameOverTrue(event) {
  var data = getFormFields(this);
  event.preventDefault();
  gameApi.showGameOverTrue(data).then(gameUi.showGameOverTrueSuccess).catch(gameUi.showGameOverTrueFailure);
};
...
var showAllGames = function showAllGames(data) {
  return $.ajax({
    url: config.apiOrigin + '/games/',
    method: 'GET',
    headers: {
...
var showGameOverTrue = function showGameOverTrue(data) {
  return $.ajax({
...
module.exports = {
  ...
  showGameOverTrue: showGameOverTrue
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var showGameOverTrueSuccess = function showGameOverTrueSuccess(data) {
  // console.log(data)
  for (var i = 0; i <= data.games.length; i++) {
    // console.log(data.games[i])
...
var showGameOverTrueFailure = function showGameOverTrueFailure() {
  // console.log(error)
...
module.exports = {
  ...
  showGameOverTrueSuccess: showGameOverTrueSuccess,
  showGameOverTrueFailure: showGameOverTrueFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
